...
class class_MyClass:
	def __init__(self, id):
		self._id = id
		self.myArray = ArrayObject([5], "myArray", "@basicType:String")
...
class Objects:
	...
	def __new__(cls):
		...
		cls.MyObject.myArray.set_objects_name("MyObject")
		cls.SecondObject = class_MyClass("@object:SecondObject")
		cls.SecondObject.__object_name__ = "SecondObject"
		cls.SecondObject.myArray.set_objects_name("SecondObject")
		try:
