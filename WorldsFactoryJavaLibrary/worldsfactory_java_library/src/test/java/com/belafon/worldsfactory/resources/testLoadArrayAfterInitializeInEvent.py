...
class CustomList(UserList):
	...
	def __setitem__(self, index, value):
		...
		if not self.direct_access:
			logging.info("{}[{}] = {}".format(self.name, indexes, value))
...
class class_BB:
	def __init__(self, id):
		self._id = id
		self.array = ArrayObject([2,2], "array", "@basicType:String")
		
	properties = {
		"__object_name__": "@basicType:String",
		"array": "@basicType:String"
	}
	def __str__(self):
		return self._id
	
	def initialize(self):
		logging.info("run method ---->   @class:BB.@method:BB_initialize")
		try:
			return self._initialize()
		except Exception as e:
			message = e.message if hasattr(e, "message") else str(e)
			class_ = "@class:BB"
			method = "@method:BB_initialize"
			raise MethodRuntimeException("An Exception in @class:BB during method @method:BB_initialize\n@class:BB\n@method:BB_initialize\n" + message)
...
class class_AA:
	...
	def initialize(self):
		logging.info("run method ---->   @class:AA.@method:AA_initialize")
		try:
			return self._initialize()
		except Exception as e:
			message = e.message if hasattr(e, "message") else str(e)
			class_ = "@class:AA"
			method = "@method:AA_initialize"
			raise MethodRuntimeException("An Exception in @class:AA during method @method:AA_initialize\n@class:AA\n@method:AA_initialize\n" + message)
...
class Objects:
	...
	def __new__(cls):
		...
		cls.b = class_BB("@object:b")
		cls.b.__object_name__ = "b"
		cls.b.array.set_objects_name("b")
		cls.a = class_AA("@object:a")
...
class event_Initialize:
	...
	def _Action(self):
		objects.b.array [0][0] = "00"
		objects.b.array [0][1] = "01"
		objects.b.array [1][0] = "10"
		objects.b.array [1][1] = "11"
