...
class class_MyClass3:
	def __init__(self, id):
		self._id = id
		
	properties = {
		"__object_name__": "@basicType:String",
		"myProperty": "@class:MyClass4"
	}
	@property
	def myProperty(self):
	...
	def myProperty(self, value):
		...
		set_property("myProperty", value, self.properties["myProperty"], self.__object_name__)
	
	def __str__(self):
		return self._id
	
	def initialize(self):
		logging.info("run method ---->   @class:MyClass3.@method:MyClass3_initialize")
		try:
			return self._initialize()
		except Exception as e:
			message = e.message if hasattr(e, "message") else str(e)
			class_ = "@class:MyClass3"
			method = "@method:MyClass3_initialize"
			raise MethodRuntimeException("An Exception in @class:MyClass3 during method @method:MyClass3_initialize\n@class:MyClass3\n@method:MyClass3_initialize\n" + message)
...
class class_MyClass4:
	...
	def initialize(self):
		logging.info("run method ---->   @class:MyClass4.@method:MyClass4_initialize")
		try:
			return self._initialize()
		except Exception as e:
			message = e.message if hasattr(e, "message") else str(e)
			class_ = "@class:MyClass4"
			method = "@method:MyClass4_initialize"
			raise MethodRuntimeException("An Exception in @class:MyClass4 during method @method:MyClass4_initialize\n@class:MyClass4\n@method:MyClass4_initialize\n" + message)
...
class Objects:
	...
	def __new__(cls):
		...
		cls.myObject = class_MyClass3("@object:myObject")
		cls.myObject.__object_name__ = "myObject"
		cls.myObject2 = class_MyClass4("@object:myObject2")
		cls.myObject2.__object_name__ = "myObject2"
		try:
			cls.myObject_initialize(cls.myObject)
			cls.myObject2_initialize(cls.myObject2)
		except Exception as e:
			print("_exception_")
	...
	def myObject2_initialize(myObject2):
		pass
